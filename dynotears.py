...
def dynotears_perso(  # pylint: disable=too-many-arguments
    data1,
    X,
    Xlags,
    p: int,
    ...
    data1 = [data1] if not isinstance(data1, list) else data1

    col_idx = {c: i for i, c in enumerate(data1[0].columns)}
...
def _format_name_from_pandas(idx_col: Dict[int, str], from_numpy_node: str):
    """
