...
def dynotears(data,X,Xlags, tau_max=5, alpha=0.0,w_threshold=0.001):
    graph_dict = dict()
...
class Dynotears(TemporalGraphicalModel):
            ...
            def infer_from_data(self, data,X,Xlags,w_threshold=0.001):
                        ...
                        tg_dict,g = dynotears(data,X,Xlags, tau_max=self.nlags, alpha=self.sig_level,w_threshold=w_threshold)
